...
public class VerdatProcessor implements TopicProcessor {
    ...
    public void process(String message) {
        ...
        // String initiall = ("");
        // String internal_sales_force_code =
        // verdatData.getInternalSalesForceCode(gsonMessage);
        // String internal_sales_force_nik =
        // verdatData.getInternalSalesForceNik(gsonMessage);
        // String internal_sales_force_name =
        // verdatData.getInternalSalesForceName(gsonMessage);
        // String internal_sales_force_job =
        // verdatData.getInternalSalesForceJob(gsonMessage);
        // String interxt_sales_force1_name =
        // verdatData.getInterxtSalesForce1Name(gsonMessage);
        // String interxt_sales_force1_npk =
        // verdatData.getInterxtSalesForce1Npk(gsonMessage);
        // String interxt_sales_force1_job =
        // verdatData.getInterxtSalesForce1Job(gsonMessage);
        // String interxt_sales_force2_name =
        // verdatData.getInterxtSalesForce2Name(gsonMessage);
        // String interxt_sales_force2_npk =
        // verdatData.getInterxtSalesForce2Npk(gsonMessage);
        // String interxt_sales_force2_job =
        // verdatData.getInterxtSalesForce2Job(gsonMessage);
