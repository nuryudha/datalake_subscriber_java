...
public class PrePPDMapper {
    ...
    // ? PREPPD
    Map<String, Object> PREPPD_detail_contract; // detail.verification_data.pre_ppd.detail_contract.obj_color
    ...
    // (VERDAT)
    // detail.verification_data.pre_ppd.detail_contract.obj_color
    public String getObjtColor(Map<String, Object> map) {
        Map<String, Object> verification_data = jsonUtility.getNestedMap(detail, "verification_data");
        Map<String, Object> pre_ppd = jsonUtility.getNestedMap(verification_data, "pre_ppd");
        this.PREPPD_detail_contract = jsonUtility.getNestedMap(pre_ppd, "detail_contract");
        return jsonUtility.getStringValue(PREPPD_detail_contract, "obj_color");
    }
    ...
    // (VERDAT)
    // detail.verification_data.pre_ppd.detail_contract.eng_capacity
    public String getEngCapacity(Map<String, Object> map) {
        return jsonUtility.getLongValue(PREPPD_detail_contract, "eng_capacity");
    }
